...
<section class="detail_pasar_virtual my-5">
    <div class="container">
        <section class="article">
            ...
            <div class="mt-2">
                <p class="font-weight-bold bg-text-blue">{{$article_procedure->procedure->title}} -
                    {{$article_procedure->fish_species->name}} / Dipublikasikan Pada
                    ...
                    <div class="btn-toolbar col" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group mr-auto" role="group" aria-label="First group">
                            <a data-toggle="tooltip" target="_blank"
                                href="https://twitter.com/share?url={{urlencode(Request::url())}}" data-placement="top"
                                title="Bagikan via Twitter" type="button" class="btn mx-2 btn-twitter rounded"><span
                                    class="fab fa-twitter fa-lg" aria-hidden="true"></span></a>
                            <a data-toggle="tooltip" target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?u={{urlencode(Request::url())}}"
                                data-placement="top" title="Bagikan via Facebook" type="button"
                                class="btn mx-2 btn-facebook rounded"><span class="fab fa-facebook fa-lg"
                                    aria-hidden="true"></span></a>
                            <a data-toggle="tooltip" target="_blank"
                                href="mailto:?subject={{urlencode($article_procedure->title)}}&body={{ urlencode(substr($article_procedure->description, 0, 50) . "
                                - " . Request::url())}}" data-placement="top" title="Bagikan via Email" type="button"
                                class="btn rounded mx-2 btn-email"><span class="fas fa-envelope-open-text fa-lg"
                                    aria-hidden="true"></span></a>
                            <a data-toggle="tooltip" target="_blank"
                                href="https://web.whatsapp.com/send?text={{urlencode(Request::url())}}"
                                data-placement="top" title="Bagikan via Whatsapp" type="button"
                                class="btn mx-2 btn-whatsapp rounded"><span class="fab fa-whatsapp fa-lg"
                                    aria-hidden="true"></span></a>
                        </div>
                    </div>
                </div>
